...
SELECT
  ...
  , array_agg(DISTINCT replace(substring(a.message, 1, least(5000, coalesce(nullif(strpos(a.message, U&'\000a'), 0), length(a.message)))), chr(10), '<br/>')) "Messages"
